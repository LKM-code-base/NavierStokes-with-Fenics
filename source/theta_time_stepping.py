...
class GeneralThetaTimeStepping(DiscreteTime):
    ...
    def __init__(self, start_time, end_time, theta_type=ThetaTimeSteppingType.FractionalStep01,
                 desired_start_time_step=0.0):
        ...
        self._intermediate_times = [[0.0] * 2 for i in range(self._n_steps)]
    ...
    def update_coefficients(self):
        ...
        if self._type == ThetaTimeSteppingType.FractionalStep01 or\
            ...
            self._intermediate_times[2][0] = next_time - self._theta * next_step_size
            ...
            self._intermediate_times[2][1] = next_time
        else:
            self._intermediate_times[0][0] = current_time
            self._intermediate_times[0][1] = next_time
        if (self.step_number == 0):
            return
        else:
            omega = next_step_size / self.get_previous_step_size()
